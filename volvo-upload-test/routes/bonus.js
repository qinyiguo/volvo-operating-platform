...
// 簽核僅需瀏覽獎金表之權限，各據點主管（無 feature:bonus_edit）即可簽名。
router.post('/bonus/signatures', requirePermission('page:bonus'), async (req, res) => {
...
router.delete('/bonus/signatures/:id', requirePermission('page:bonus'), async (req, res) => {
  try {
